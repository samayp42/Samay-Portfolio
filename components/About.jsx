...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Hello! I&apos;m Samay Patel, a passionate AI innovator and problem solver. I&apos;m a final-year B.Tech CSE student at Charusat University in Anand, India, with an expected graduation in 2025. I&apos;m currently interning at Oizom, where I develop AI-driven solutions like chatbots, real-time insights, and geospatial tools. I specialize in Python, LLMs, Langchain, and AI Automations, with a strong foundation in NLP, RAG, and design thinking. My goal is to create impactful AI systems that empower businesses and communities.
          <br className="sm:block hidden" />
          Let&apos;s collaborate to innovate for a better future!
        </div>
        <div className="w-fit break-words">
          <Link
            href="mailto:samaypatel423@gmail.com"
            target="_blank"
            rel="noreferrer"
